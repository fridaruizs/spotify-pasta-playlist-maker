...
class Client:
    """Client performs operations using the Spotify API."""

    def __init__(self, authorization_token, user_id, playlist_id):
        """
        :param authorization_token (str): Spotify API token
        :param user_id (str): Spotify user id
        :param playlist_id (str): Spotify playlist_id
        """
    ...
    def get_my_playlist(self):
        """
        :return playlist (Playlist): My found playlist
        """
        url = f"https://api.spotify.com/v1/playlists/{self._playlist_id}"
        response = self._place_get_api_request(url)
        response_json = response.json()
...
# get_playlist_time() #default 00:10:00
# generate_playlist() #or update
# populate()

# track.py
# get_random_track_by_time()
# get_random_time_within_playlist_time()

# TODO: cool other methods, pick genre, add specific song